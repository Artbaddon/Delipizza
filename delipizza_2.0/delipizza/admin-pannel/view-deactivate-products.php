    ...
    <div class="main-container">
        ...
        <section class="show-product">
            ...
            <div class="box-container">
                <?php
                $select_product = $conn->prepare("SELECT * FROM producto WHERE estado='inactivo'");
                ...
                <p>No hay productos inactivos <br><a href="add-products.php" class="btn" style="margin-top: 1.5rem;">Añadir producto</a></p>
            </div>';
                }
